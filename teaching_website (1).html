...
<body class="font-sans antialiased text-gray-900 scroll-smooth">
  ...
  <nav class="bg-white shadow fixed w-full z-10">
    <div class="max-w-6xl mx-auto px-4">
      <div class="flex justify-between items-center py-4">
        <div class="text-2xl font-bold">Berfin English</div>
  ...
  <!-- Hero Section -->
  <section class="bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-center py-32 mt-16" id="hero">
  ...
  <section id="services" class="bg-gray-100 py-20 px-4">
    ...
    <!-- Modals -->
    <div id="modal-general" class="hidden fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
    ...
    <div id="modal-business" class="hidden fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div class="bg-white p-6 rounded-lg w-3/4 max-w-lg">
    ...
    <div id="modal-exam" class="hidden fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div class="bg-white p-6 rounded-lg w-3/4 max-w-lg">
